...
from .resume_analysis import analyze_resume_view, resume_analysis
from .transcript_job_title import extract_transcript_text, upload_transcript
...
urlpatterns = [
    ...
    path(
        "extract-technical-skills/<path:file_path>/",
    ...
    path(
        "extract-transcript/<path:file_path>/",
        extract_transcript_text,
        name="extract_transcript_text",
    ),
]
