...
from . import generate_skills, job_description_algorithm, views
from .gpt_calls import execute_input, generate_mcqs, get_skills_from_chatgpt
...
urlpatterns = [
    ...
    path(
        "save-job/<int:job_id>/", views.save_job_not_ajax, name="save_job_not_ajax"
    ),  # Add this line
    ...
    path(
        "answer/<int:job_id>/success", views.job_application_success, name="job_application_success"
    ),
    path(
        "get_questions_for_skill/<int:skill_id>/",
        views.get_questions_for_skill,
        name="get_questions_for_skill",
    ),
    ...
    path(
        ...
        job_description_algorithm.extract_technical_skills_endpoint,
        name="extract_technical_skills",
    ),
    path("applied-jobs/", views.user_applied_jobs, name="applied_jobs"),
    path(
        "withdraw-application/<int:job_id>/",
