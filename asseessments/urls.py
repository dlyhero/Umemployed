...
urlpatterns = [
    ...
    path(
        "assessment/update/<int:assessment_id>/", views.update_assessment, name="update_assessment"
    ),
    path(
        "assessment/delete/<int:assessment_id>/", views.delete_assessment, name="delete_assessment"
    ),
    path("assessment/list/", views.assessment_list, name="assessment_list"),
    path(
        "assessment/detail/<int:assessment_id>/", views.assessment_detail, name="assessment_detail"
    ),
    # URLs for user views
