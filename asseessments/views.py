...
from .forms import AssessmentForm, OptionForm, QuestionForm
from .models import Assessment, Option, Question, Result, Session
...
def available_assessments(request):
    assessments = Assessment.objects.all()
    return render(
        request, "assessments/user/available_assessments.html", {"assessments": assessments}
    )
...
def session_results(request, session_id):
    ...
    return render(
        request, "assessments/user/session_results.html", {"session": session, "results": results}
    )
