...
def send_welcome_email(user_email, user_name):
    ...
    thread = threading.Thread(target=send_email, args=(subject, plain_message, settings.DEFAULT_FROM_EMAIL, [user_email], html_message))
    thread.start()
...
def send_application_email(recruiter_email, applicant_name, job_title, job_link):
    ...
    html_message = render_to_string('emails/job_application.html', {
    ...
    thread = threading.Thread(target=send_email, args=(subject, plain_message, settings.DEFAULT_FROM_EMAIL, [recruiter_email], html_message))
    thread.start()
